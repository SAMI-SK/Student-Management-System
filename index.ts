...
class Student_manager {
  ...
  view_student_balance(student_id: number) {
    ...
    if(student){
        ...
        console.log("Student not found. Please enter a correctstudent ID");
...
async function main() {
  console.log("Welcome to 'SAMI' - Student Management System");
  console.log("-".repeat(50));

  let student_manager = new Student_manager();

  // Promt the user to add a new student
  while (true) {
